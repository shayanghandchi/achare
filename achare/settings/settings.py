...
USER_TIMEOUT_SECOND = os.environ.get("OTP_TIMEOUT_SECOND", 60 * 60)
IP_TIMEOUT_SECOND = os.environ.get("OTP_TIMEOUT_SECOND", 60 * 60)
OTP_CHECK_MAX_ATTEMPT = os.environ.get("OTP_CHECK_MAX_ATTEMPT", 3)
BLOCK_TIMEOUT_SECOND = os.environ.get("BLOCK_TIMEOUT_SECOND", 60 * 60)
